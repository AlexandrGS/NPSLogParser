...
Столбцы файла ResultSessions.csv, содержащего подробную инфо по каждой сессии
...
Столбцы файла ResultUsage.csv содержащего сумму по каждому пользователю
UserName - имя пользователя. То же что и в файлеResultSessions.csv
ConnectionsOk - количество успешных соединений пользователя из UserName. Успешными считаются те сессии у которых нбыл этап "Accounting".
ConnectionsBad - количество неудачных соединений пользователя из UserName. Неудачными считаются те сессии у которых отсутствовал этап "Accounting".
DurationSec - сумма такого значения такого же столбца у всех сессий ползователя UserNam. Длительность всех сессий пользователя из UserName в секундах
DurationSecFromBeginTime - сумма такого значения такого же столбца у всех сессий ползователя UserName
DurationHourMinSec - сумма такого значения такого же столбца у всех сессий ползователя UserName. Как и DurationSec, только в виде ЧЧ:ММ:СС
DurationHourMinSecFromBeginTime - сумма такого значения такого же столбца у всех сессий ползователя UserName
DateTimeFirst - дата и время первой сессии пользователя UserName
DateTimeLast - дата и время последней сессии пользователя UserName
InputOctets - сумма такого значения такого же столбца у всех сессий ползователя UserName
InputOctetsFromBeginTime - сумма такого значения такого же столбца у всех сессий ползователя UserName
InputPackets - сумма такого значения такого же столбца у всех сессий ползователя UserName
InputPacketsFromBeginTime - сумма такого значения такого же столбца у всех сессий ползователя UserName
